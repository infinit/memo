...
namespace elle
{
  ...
  {
    template<>
    struct Serialize<memo::model::NodeLocation>
    {
      using Type = std::pair<memo::model::Address,
                             boost::container::flat_set<memo::model::Endpoint>>;
      static
      Type
      convert(memo::model::NodeLocation const& nl);
      static
      memo::model::NodeLocation convert(Type const& repr);
    };
  }
}
