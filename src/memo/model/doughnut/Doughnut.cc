...
namespace
{
  ...
  make_member_gauge(memo::model::doughnut::Doughnut const& dht)
  {
  ...
  memo::prometheus::GaugePtr
  make_storage_blocks_gauge(memo::model::doughnut::Doughnut const& dht)
  {
    static auto* family
      = memo::prometheus::instance().make_gauge_family(
          "memo_storage_blocks",
  ...
  /// @return nullptr if set up failed.
  memo::prometheus::GaugePtr
  make_storage_bytes_gauge(memo::model::doughnut::Doughnut const& dht)
  {
    static auto* family
      = memo::prometheus::instance().make_gauge_family(
          "memo_storage_bytes",
  ...
  const auto _dht_ser
    = elle::serialization::Hierarchy<memo::model::ModelConfig>
  ...
  namespace model
  {
    namespace doughnut
    {
          ...
          if (!bfs::exists(m_path))
          {
            ...
            catch (elle::reactor::network::PermissionDenied const& e)
            {
              ELLE_WARN("unable to monitor, check "
                        "MEMO_RUNTIME_DIR or XDG_RUNTIME_DIR");
              throw;
            }
        ...
        boost::optional<bfs::path> monitoring_socket_path)
      {
        ...
        return std::make_unique<memo::model::doughnut::Doughnut>(
          this->id,
