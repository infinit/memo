#include <memo/storage/Async.hh>

#include <boost/filesystem.hpp>
#include <boost/filesystem/fstream.hpp>

#include <memo/model/Address.hh>
#include <memo/storage/MissingKey.hh>
...
ELLE_LOG_COMPONENT("memo.fs.async");
...
namespace memo
{
  namespace storage
  {
    ...
    namespace
    {
      std::unique_ptr<memo::storage::Storage>
    ...
    public:
      ...
      make() override
      {
        return std::make_unique<memo::storage::Async>(
...
FACTORY_REGISTER(memo::storage::Storage, "async", &memo::storage::make);
