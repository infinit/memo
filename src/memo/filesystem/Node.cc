...
ELLE_LOG_COMPONENT("memo.filesystem.Node");
  ...
  namespace filesystem
  {
    ...
    public:
                ...
                elle::Version const& v) override
      {
        ...
        if (s.in())
        {
          memo::model::doughnut::Doughnut* model = nullptr;
    ...
    {
      ELLE_LOG_COMPONENT("memo.filesystem.Node.xattr");
...
#  pragma GCC diagnostic pop
      ...
      if (keys.K() != *acb->owner_key())
        THROW_ACCES();
      std::unique_ptr<memo::model::User> user =
