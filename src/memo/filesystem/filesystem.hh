...
#include <memo/filesystem/fwd.hh>
  ...
  namespace filesystem
  {
    ...
    public:
      ...
      FileSystem(
        ...
        std::shared_ptr<memo::model::Model> model,
    ...
    public:
      ...
      owner() const;
      ELLE_ATTRIBUTE_R(std::shared_ptr<memo::model::Model>, block_store);
...
#include <memo/filesystem/filesystem.hxx>
